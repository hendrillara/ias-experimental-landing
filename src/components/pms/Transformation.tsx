...
export default function PMTransformation() {
  return (
    <section className="relative z-10 min-h-[60vh] flex items-center justify-center px-6">
      ...
      >
        ...
        <motion.div
          ...
          className="h-px bg-blue-400/40 mx-auto mt-8"
        />
      </motion.div>
    </section>
  );
